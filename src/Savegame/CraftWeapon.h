...
public:
	...
	/// Is the weapon allowed to be reloaded?
	void setReloadingDisabled(bool reloadDisabled);
	/// Sets whether the weapon is allowed to be reloaded or not.
	bool isReloadingDisabled() const;
